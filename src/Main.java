...
public class Main {
    public static void main(String[] args) {
        ...
        arr[11] = 1;
        // Запускаю цикл, который пройдётся по всем 12 ячейкам массива
        ...
        for (int index = 0; index < arr.length - 1; index++) {
            // Вывожу значения элементов массива arr кроме последнего по порядку через запятую
            System.out.print(arr[index] + ", ");
        }
        // Вывожу последнее значение элемента массива arr
        System.out.println(arr[arr.length - 1]);
        // Запускаю цикл, который пройдётся по заполненным ячейкам массива
        for (int index = 0; index < arrD.length - 1; index++) {
            // Вывожу значения элементов массива arrD кроме последнего по порядку через запятую
            System.out.print(arrD[index] + ", ");
        }
        // Вывожу последнее значение элемента массива arrD
        ...
        for (int index = arr.length - 1; index > 0; index--) {
            // Вывожу с последнего значения элементов массива в обратном порядке через запятую
            System.out.print(arr[index] + ", ");
        }
